...
SET DEFINE OFF;
REM INSERTING into SYSTEM.BRANDS
SET DEFINE OFF;
Insert into SYSTEM.BRANDS (BID,BNAME) values (1,'Apple');
Insert into SYSTEM.BRANDS (BID,BNAME) values (2,'Samsung');
Insert into SYSTEM.BRANDS (BID,BNAME) values (3,'Nike');
Insert into SYSTEM.BRANDS (BID,BNAME) values (4,'Fortune');
REM INSERTING into SYSTEM.CATEGORIES
SET DEFINE OFF;
Insert into SYSTEM.CATEGORIES (CID,CATEGORY_NAME) values (1,'Electronics');
Insert into SYSTEM.CATEGORIES (CID,CATEGORY_NAME) values (2,'Clothing');
Insert into SYSTEM.CATEGORIES (CID,CATEGORY_NAME) values (3,'Grocery');
REM INSERTING into SYSTEM.CUSTOMER_CART
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER_CART (CART_ID,NAME,MOBILE) values (1,'Ram',987654321);
Insert into SYSTEM.CUSTOMER_CART (CART_ID,NAME,MOBILE) values (2,'Kumari',777777777);
Insert into SYSTEM.CUSTOMER_CART (CART_ID,NAME,MOBILE) values (3,'Suraj',777777775);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.INV_USER
SET DEFINE OFF;
Insert into SYSTEM.INV_USER (USER_ID,NAME,PASSW,LAST_LOGIN,USER_TYPE) values ('supragya24@gmail.com','Supragya','1234',to_timestamp('15-12-22 1:22:11.000000000 PM','DD-MM-RR fmHH12:fmMI:SSXFF AM'),'admin');
Insert into SYSTEM.INV_USER (USER_ID,NAME,PASSW,LAST_LOGIN,USER_TYPE) values ('harish1255@gmail.com','Harish','1111',to_timestamp('16-12-22 5:56:17.000000000 PM','DD-MM-RR fmHH12:fmMI:SSXFF AM'),'Manager');
Insert into SYSTEM.INV_USER (USER_ID,NAME,PASSW,LAST_LOGIN,USER_TYPE) values ('prashant11@gmail.com','Prashant','11',to_timestamp('14-12-22 7:02:41.000000000 PM','DD-MM-RR fmHH12:fmMI:SSXFF AM'),'Accountant');
...
SET DEFINE OFF;
Insert into SYSTEM.PRODUCT (PID,CID,BID,SID,PNAME,P_STOCK,PRICE,ADDED_DATE) values (1,1,1,1,'iPhone',4,80000,to_date('15-12-22','DD-MM-RR'));
Insert into SYSTEM.PRODUCT (PID,CID,BID,SID,PNAME,P_STOCK,PRICE,ADDED_DATE) values (2,1,1,1,'Airpods',3,19000,to_date('15-12-22','DD-MM-RR'));
Insert into SYSTEM.PRODUCT (PID,CID,BID,SID,PNAME,P_STOCK,PRICE,ADDED_DATE) values (3,1,2,1,'Smart Watch',3,19000,to_date('15-12-22','DD-MM-RR'));
Insert into SYSTEM.PRODUCT (PID,CID,BID,SID,PNAME,P_STOCK,PRICE,ADDED_DATE) values (4,2,3,2,'Air Jordan Shoes',6,17000,to_date('16-12-22','DD-MM-RR'));
Insert into SYSTEM.PRODUCT (PID,CID,BID,SID,PNAME,P_STOCK,PRICE,ADDED_DATE) values (5,3,4,3,'Refined Oil',6,750,to_date('14-12-22','DD-MM-RR'));
REM INSERTING into SYSTEM.PROVIDESTO
SET DEFINE OFF;
Insert into SYSTEM.PROVIDESTO (BID,SID,DISCOUNT) values (1,1,12);
Insert into SYSTEM.PROVIDESTO (BID,SID,DISCOUNT) values (2,2,7);
Insert into SYSTEM.PROVIDESTO (BID,SID,DISCOUNT) values (3,3,15);
Insert into SYSTEM.PROVIDESTO (BID,SID,DISCOUNT) values (1,2,7);
Insert into SYSTEM.PROVIDESTO (BID,SID,DISCOUNT) values (4,2,19);
Insert into SYSTEM.PROVIDESTO (BID,SID,DISCOUNT) values (4,3,20);
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SELECT_PRODUCT
SET DEFINE OFF;
Insert into SYSTEM.SELECT_PRODUCT (CUST_ID,PID,QUANTITY) values (1,2,1);
Insert into SYSTEM.SELECT_PRODUCT (CUST_ID,PID,QUANTITY) values (1,3,2);
Insert into SYSTEM.SELECT_PRODUCT (CUST_ID,PID,QUANTITY) values (2,1,1);
Insert into SYSTEM.SELECT_PRODUCT (CUST_ID,PID,QUANTITY) values (3,3,1);
REM INSERTING into SYSTEM.SQLPLUS_PRODUCT_PROFILE
SET DEFINE OFF;
REM INSERTING into SYSTEM.STORES
SET DEFINE OFF;
Insert into SYSTEM.STORES (SID,SNAME,ADDRESS,MOBNO) values (1,'AMart','Delhi',99999999);
Insert into SYSTEM.STORES (SID,SNAME,ADDRESS,MOBNO) values (2,'BMart','Chennai',88888008);
Insert into SYSTEM.STORES (SID,SNAME,ADDRESS,MOBNO) values (3,'CMart','Haryana',77775555);
REM INSERTING into SYSTEM.TRANSACTIONS
SET DEFINE OFF;
Insert into SYSTEM.TRANSACTIONS (TID,TOTAL_AMOUNT,PAID,DUE,TAX,DISCOUNT,PAYMENT_METHOD,CART_ID) values (1,90000,91000,1000,3100,1550,'card',1);
Insert into SYSTEM.TRANSACTIONS (TID,TOTAL_AMOUNT,PAID,DUE,TAX,DISCOUNT,PAYMENT_METHOD,CART_ID) values (2,25000,25000,0,1250,750,'cash',2);
Insert into SYSTEM.TRANSACTIONS (TID,TOTAL_AMOUNT,PAID,DUE,TAX,DISCOUNT,PAYMENT_METHOD,CART_ID) values (3,42000,42000,0,2100,2190,'cash',3);
